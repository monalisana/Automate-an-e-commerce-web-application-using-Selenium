...
class BaseClass:
    ...
    def takeScreenshot(self, locatorType):
    ...
    def select_option_in_dropdown(self, locatorValue, locatorType="id", optionValue=None,optionText=None, optionIndex=None):
        try:
            locatorType = locatorType.lower()
            webElement = self.waitForElement(locatorValue, locatorType)
            ...
            if optionValue is not None:
                ...
                raise ValueError("Either optionValue or optionIndex must be provided.")
